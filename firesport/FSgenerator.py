...
class FSgenerator:
	...
	def get_track(self, strain=1, pole=0):
		...
		generace trati, rozměr 18mx105m (36X210 polí), trat je 4Dpole, rozdělené po 0.5m. v prvni vrstvě je určeno o jaký typ povrchu a jeho stupen kvality (O-100) se jedná. V další vrstvě hodnota podmáčenosti(0-100) a v poslední rozmístění nářaadí (základna, káď, značky..)"""
